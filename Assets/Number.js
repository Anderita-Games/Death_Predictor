...
var Gender : UnityEngine.UI.InputField;
var Country : UnityEngine.UI.InputField;
var Smoker : UnityEngine.UI.InputField;
var Weight : UnityEngine.UI.InputField;
var Height : UnityEngine.UI.InputField;

var Title : UnityEngine.UI.Text;

var Birth : GameObject;
var Factors : GameObject;
	
function Start () {
	Debug.Log(PlayerPrefs.GetFloat("Year"));
	if (PlayerPrefs.GetString("Gender") != "" && PlayerPrefs.GetString("Country") != "" ) {
		yield WaitForSeconds (.01);
		if (PlayerPrefs.GetString("Smoker") != "" && PlayerPrefs.GetString("Weight") != "" && PlayerPrefs.GetString("Height") != "") {
			Application.LoadLevel ("Stats");
		}
	}else if (PlayerPrefs.GetFloat("Month") != 0 && PlayerPrefs.GetFloat("Day") != 0 && PlayerPrefs.GetFloat("Year") != 0) {
		Birth.SetActive(false);
		Factors.SetActive(true);
		Title.text = "Enter Additional Info";
	}
}
...
function Update () {
	if (PlayerPrefs.GetFloat("Month") != 0 && PlayerPrefs.GetFloat("Day") != 0 && PlayerPrefs.GetFloat("Year") != 0) {
		...
		Factors.SetActive(true);
		Title.text = "Enter Additional Info";
	}else if (PlayerPrefs.GetString("Gender") != "" && PlayerPrefs.GetString("Country") != "" ) {
		if (PlayerPrefs.GetString("Smoker") != "" && PlayerPrefs.GetString("Weight") != "" && PlayerPrefs.GetString("Height") != "") {
			Application.LoadLevel ("Stats");
		}
	}
...
function Smokers () {
	PlayerPrefs.SetString("Smoker", Smoker.text);
}
